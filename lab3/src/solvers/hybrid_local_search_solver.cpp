...
HybridLocalSearchSolver::HybridLocalSearchSolver(const int seed, const int max_time_ms, const int candidate_k)
    : Lab3BaseSolver(seed, max_time_ms, candidate_k) {}

SolveResult HybridLocalSearchSolver::solve(const Instance& instance, const int start_node) {
